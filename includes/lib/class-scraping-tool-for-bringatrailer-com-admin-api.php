 ...
 * Admin API class.
 */
class Scraping_Tool_for_Bringatrailer_com_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'scraping-tool-for-bringatrailer.com' ) . '" data-uploader_button_text="' . __( 'Use image', 'scraping-tool-for-bringatrailer.com' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'scraping-tool-for-bringatrailer.com' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'scraping-tool-for-bringatrailer.com' ) . '" />' . "\n";
